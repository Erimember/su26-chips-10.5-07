...
# This runs once when rspec loads
system('bin/rails javascript:build css:build >/dev/null')
...
RSpec.configure do |config|
  config.before(:suite) do
    ...
    # In Rspec Seeds are not loaded.
    # Loading seeds will require fixing some existing tests.
